      ...
      <div className="px-3 py-3 lg:px-5 lg:pl-3">
         <div className="flex items-center justify-between">
            <div className="flex items-center justify-start">
               ...
               <span className="self-center whitespace-nowrap"><div className="uppercase text-gray-800 dark:text-white font-black text-3xl">
              HEALTHIFY
            </div></span>
               </a>
               <form action="#" method="GET" className="hidden lg:block lg:pl-32">
                  ...
                  <div className="mt-1 relative lg:w-64">
                     ...
                     <input type="text" name="email" id="topbar-search" className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-emerald-600 focus:border-emerald-600 block w-full pl-10 p-2.5" placeholder="Search" />
                  </div>
               </form>
            </div>
            <div className="flex items-center">
               ...
               <div className="hidden lg:flex items-center">
                  <span className="text-base font-normal text-gray-500 mr-5">Hello World</span>
                  <div className="-mb-1">
               ...
               <a href="#" className="hidden sm:inline-flex ml-5 text-white bg-emerald-600 hover:bg-emerald-700 focus:ring-4 focus:ring-emerald-200 font-medium rounded-lg text-sm px-5 py-2.5 text-center items-center mr-3">
   ...
   <div className="flex overflow-hidden bg-white pt-16">
                     ...
                     <li>
                        <form action="#" method="GET" className="lg:hidden">
                           ...
                           <div className="relative">
                              ...
                              <input type="text" name="email" id="mobile-search" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-emerald-600 focus:ring-emerald-600 block w-full pl-10 p-2.5" placeholder="Search" />
                           </div>
                        </form>
                     </li>
                     <li>
      ...
      <div id="main-content" className="h-full w-full bg-gray-50 relative overflow-y-auto lg:ml-64">
               ...
               <div className="w-full grid grid-cols-1 xl:grid-cols-2 2xl:grid-cols-3 gap-4">
                  ...
                  <div className="bg-white shadow rounded-lg p-4 sm:p-6 xl:p-8 ">
                     <div className="mb-4 flex items-center justify-between">
                        ...
                        <div className="flex-shrink-0">
                           <a href="#" className="text-sm font-medium text-emerald-600 hover:bg-gray-100 rounded-lg p-2">View all</a>
                        </div>
                     </div>
               ...
               <div className="grid grid-cols-1 2xl:grid-cols-2 xl:gap-4 my-4">
                  <div className="bg-white shadow rounded-lg mb-4 p-4 sm:p-6 h-full">
                     <div className="flex items-center justify-between mb-4">
                        ...
                        <a href="#" className="text-sm font-medium text-emerald-600 hover:bg-gray-100 rounded-lg inline-flex items-center p-2">
                        View all
                        </a>
                     </div>
                                    ...
                                    <div className="flex items-center">
                                       ...
                                       <div className="relative w-full">
                                          <div className="w-full bg-gray-200 rounded-sm h-2">
                                             <div className="bg-emerald-600 h-2 rounded-sm"></div>
                                          </div>
                                       </div>
                                    </div>
                                 </td>
         ...
         <p className="text-center text-sm text-gray-500 my-10">
            &copy; 2023 <a href="#" className="hover:underline" target="_blank">Yash</a>. All rights reserved.
         </p>
      </div>
   </div>
