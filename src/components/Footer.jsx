        ...
        <div className="container px-4 mx-auto">
            ...
            <div className="flex flex-wrap -m-8">
                ...
                <ul>
                    ...
                    <li className="mb-3.5"><a className="text-gray-600 hover:text-gray-700 font-medium leading-relaxed" href="#">Press</a></li>
                    <li><a className="text-gray-600 hover:text-gray-700 font-medium leading-relaxed" href="#">Blog</a></li>
                </ul>
                </div>
                <div className="w-full sm:w-1/2 lg:w-2/12 p-8">
                <h3 className="mb-6 font-semibold leading-normal">Pages</h3>
                <ul>
                    <li className="mb-3.5"><a className="text-gray-600 hover:text-gray-700 font-medium leading-relaxed" href="#">Login</a></li>
                    <li className="mb-3.5"><a className="text-gray-600 hover:text-gray-700 font-medium leading-relaxed" href="#">Register</a></li>
                    <li className="mb-3.5"><a className="text-gray-600 hover:text-gray-700 font-medium leading-relaxed" href="#">Add list</a></li>
                    <li><a className="text-gray-600 hover:text-gray-700 font-medium leading-relaxed" href="#">Contact</a></li>
                </ul>
                </div>
                <div className="w-full sm:w-1/2 lg:w-2/12 p-8">
                <h3 className="mb-6 font-semibold leading-normal">Legal</h3>
                <ul>
                    <li className="mb-3.5"><a className="text-gray-600 hover:text-gray-700 font-medium leading-relaxed" href="#">Terms</a></li>
                    <li className="mb-3.5"><a className="text-gray-600 hover:text-gray-700 font-medium leading-relaxed" href="#">About Us</a></li>
                    <li className="mb-3.5"><a className="text-gray-600 hover:text-gray-700 font-medium leading-relaxed" href="#">Team</a></li>
                    <li><a className="text-gray-600 hover:text-gray-700 font-medium leading-relaxed" href="#">Privacy</a></li>
                </ul>
                </div>
                <div className="w-full sm:w-1/2 lg:w-2/12 p-8">
                <h3 className="mb-6 font-semibold leading-normal">Resources</h3>
                <ul>
                    <li className="mb-3.5"><a className="text-gray-600 hover:text-gray-700 font-medium leading-relaxed" href="#">Blog</a></li>
                    <li className="mb-3.5"><a className="text-gray-600 hover:text-gray-700 font-medium leading-relaxed" href="#">Service</a></li>
                    <li className="mb-3.5"><a className="text-gray-600 hover:text-gray-700 font-medium leading-relaxed" href="#">Product</a></li>
                ...
                <div className="lg:max-w-sm">
                    ...
                    <p className="mb-5 font-sans text-gray-600 leading-relaxed">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                    <div className="mb-3 xl:pl-6 inline-block md:max-w-xl w-full overflow-hidden border border-gray-300 rounded-xl focus-within:ring focus-within:ring-emerald-300">
                    <div className="flex flex-wrap items-center">
                        <div className="w-full xl:flex-1">
                        <input className="p-3 xl:p-0 xl:pr-6 w-full font-medium text-gray-500 placeholder-gray-500 outline-none border-transparent focus:border-transparent focus:ring-0" id="footerInput1-1" type="text" placeholder="Type your e-mail" />
                        </div>
                        <div className="w-full xl:w-auto">
                        <div className="block">
                            <button className="py-4 px-8 w-full text-white font-semibold border border-emerald-700 focus:ring focus:ring-emerald-300 bg-emerald-600 hover:bg-emerald-700 transition ease-in-out duration-200" type="button">Subscribe</button>
                        </div>
                        </div>
                    </div>
                    </div>
            ...
            <div className="w-auto p-4">
                <p className="text-sm text-gray-600 font-medium">Copyright &copy; 2022 Healthify. All Rights Reserved</p>
            </div>
            <div className="w-auto p-4">
                <div className="flex flex-wrap -m-4">
                <div className="w-auto p-4">
                    <a className="text-blueGray-400 hover:text-emerald-500" href="#">
